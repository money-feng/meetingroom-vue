            ...
            <el-row>
              <el-col :span="12">
                ...
                <el-col :span="18">
                  ...
                  <el-input class="input-new-tag" v-if="addEquipmentVisible" v-model="addEquipmentValue"
                  ...
                  <el-button v-else class="button-new-tag" size="small" @click="addEquipment">添加设备</el-button>
                </el-col>
